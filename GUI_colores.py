...
class DownloaderApp(QWidget):
    ...
    def initUI(self):
        ...
        # Establecer el color de fondo del widget principal a través de una gradiente lineal
        self.setStyleSheet("background-color: qlineargradient(x1:0, y1:0, x2:1, y2:0, stop:0 #07D2FB, stop:0.5 #0819B5, stop:1 #21FCC7);")

        layout = QVBoxLayout()

        self.url_label = QLabel("URL del video de YouTube:")
        # Establecer el tamaño de la fuente y el color del texto del QLabel
        self.url_label.setStyleSheet("font-size: 20px; color: black;")
